...
import bawei.com.health_im.util.AndroidUtils;
...
public class VoiceActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audiocheck = intent.getStringExtra("audiocheck");
        videocheck = intent.getStringExtra("videocheck");
        ...
        Button audio = findViewById(R.id.btn_audio_call);
    ...
    public void onClick(View v) {
        String username;
        int i = v.getId();
        if (i == R.id.btn_video_call) {


                startCall( JMSignalingMessage.MediaType.VIDEO);


        } else if (i == R.id.btn_audio_call) {


                startCall(JMSignalingMessage.MediaType.AUDIO);


        } else if (i == R.id.btn_resolution) {
            openOptionsMenu();
        ...
        } else if (i == R.id.btn_hangup) {
            hangUp();

        } else if (i == R.id.btn_enable_video) {
    ...
    private void startCall( final JMSignalingMessage.MediaType mediaType) {
        JMRtcClient.getInstance().call(list, mediaType, new BasicCallback() {
            @Override
            public void gotResult(int i, String s) {
                Log.d( TAG, "call send complete . code = " + i + " msg = " +s);
                postTextToDisplay("startCall", i, s, "发起通话成功,等待对方响应", "发起失败");
            }
        });
    }
    ...
    JMRtcListener jmRtcListener = new JMRtcListener() {
        ...
        public void onPermissionNotGranted(final String[] requiredPermissions) {
            ...
            try {
                AndroidUtils.requestPermission(VoiceActivity.this, requiredPermissions);
    ...
    public void getUserinfo(UserInfo userInfo){
        ...
        Log.i("zzzzzzzzzz","xxxxxxxxxxx"+userInfo);
    }
